...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/09/15 17:16:58 by jmelende          #+#    #+#              #
#    Updated: 2023/09/15 17:17:01 by jmelende         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = \
		ft_bzero.c ft_memcpy.c ft_memset.c ft_memmove.c ft_memchr.c \
